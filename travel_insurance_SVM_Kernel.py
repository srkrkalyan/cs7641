...
# -*- coding: utf-8 -*-
"""
Created on Sun Feb  3 21:12:06 2019
...
print("SVM Kernel model accuracy: ", round(metrics.accuracy_score(y_test,y_pred),4))
...
plt.title('SVM Kernel (After Optimization) - Travel Insurance Data Set', fontsize = 18, y = 1.03)
plt.legend()
plt.ylim(0.98,1)
